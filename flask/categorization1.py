...
problems = [
    ...
    "#iamfine. Thanks team, Now my work has been done successfully. Investigate and resolve recurring instances of delayed transaction processing within our banking system, impacting customer satisfaction and operational efficiency. Identify and rectify the systemic issue causing transactions to fail without generating error messages in our banking system, leading to customer confusion and operational challenges.",
]
...
def preprocess_text(text):
    ...
    text = text.lower()
    # Remove punctuation (not implemented here, add as needed)
    return text
...
# Define the correct category for each problem
target_labels = [
    'Transaction Issues', 'Transaction Issues', 'Transaction Issues', 'Transaction Issues', 'Transaction Issues',
    'Account Access Issues', 'Login Problems', 'Login Problems', 'Account Access Issues', 'Account Access Issues',
    'Account Access Issues', 'Server Connectivity', 'Server Connectivity', 'Other'
]
